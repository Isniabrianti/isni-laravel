...
class PollTelegramUpdates implements ShouldQueue
{
    ...
    // {
    //     $response = Http::get("https://api.telegram.org/7208791187:AAHdL-wMKV2noG1gMI6cnzdQW4PnSezcUDo" . env('TELEGRAM_BOT_ID') . "/getUpdates");
    ...
    //                 Http::post("https://api.telegram.org/7208791187:AAHdL-wMKV2noG1gMI6cnzdQW4PnSezcUDo" . env('TELEGRAM_BOT_ID') . "/sendMessage", [
    //                     'chat_id' => $chatId,
